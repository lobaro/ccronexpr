...
void test_expr() {
    ...
    // H Tests
    init_hash(7);
    check_next("H H H H H ?",       "2022-05-12_00:00:00", "2022-10-12_12:43:49"); // 49 43 12 12 10 ?
    ...
    init_hash(42);
    check_next("H H H H H ?",       "2022-05-12_00:00:00", "2022-07-04_17:43:54"); // 54 43 17 4 7 ?
    ...
    check_next("0 0 1 ? * TUE/H",   "2022-05-18_00:00:00", "2022-05-24_01:00:00");
    init_hash(54321);
    check_next("H H H H H ?",       "2022-05-12_00:00:00", "2023-04-29_22:34:27"); // 27 34 22 29 4 ?
